//===- CHALKAnnotations.h - Code for working with Annotations --*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares helpers for working with CHALK annotations.
//
//===----------------------------------------------------------------------===//

#ifndef CIRCT_DIALECT_CHALK_ANNOTATIONS_H
#define CIRCT_DIALECT_CHALK_ANNOTATIONS_H
...
/// Return the name of the attribute used for annotations on CHALK ops.
inline StringRef getAnnotationAttrName() { return "annotations"; }

/// Return the name of the attribute used for port annotations on CHALK ops.
...
inline StringRef getDialectAnnotationAttrName() { return "chalk.annotations"; }
...
public:
  ...
  /// Store the annotations in this set in a `NamedAttrList` as an array
  /// attribute with the name `chalk.annotations`. Overwrites existing
  /// annotations. Removes the `chalk.annotations` attribute if the set is
  ...
  /// `applyToPortAttrList` allows you to set the `chalk.annotations` attribute
  ...
  /// `chalk.annotations` key. Overwrites any existing attribute stored under
  /// `chalk.annotations`. Removes the `chalk.annotations` attribute in the
  ...
  /// want to set the `chalk.annotations` key in the dictionary to the contents
  /// of this set.
  ...
  /// chalk.transforms.DontTouchAnnotation
...
template <>
struct PointerLikeTypeTraits<circt::chalk::Annotation>
    : PointerLikeTypeTraits<mlir::Attribute> {
  using Annotation = circt::chalk::Annotation;
...
template <>
struct DenseMapInfo<circt::chalk::Annotation> {
  using Annotation = circt::chalk::Annotation;
...
#endif // CIRCT_DIALECT_CHALK_ANNOTATIONS_H
