...
//===----------------------------------------------------------------------===//
//
// This file defines the CHALK NLATable.
//
//===----------------------------------------------------------------------===//
#ifndef CIRCT_DIALECT_CHALK_NLATABLE_H
#define CIRCT_DIALECT_CHALK_NLATABLE_H
...
public:
  /// Create a new NLA table of a circuit.  This must be called on a CHALK
...
#endif // CIRCT_DIALECT_CHALK_NLATABLE_H
