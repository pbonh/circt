//===- CHALKOpInterfaces.h - Declare CHALK op interfaces ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the operation interfaces for the CHALK IR and supporting
// types.
//
//===----------------------------------------------------------------------===//

#include "circt/Dialect/CHALK/CHALKAnnotations.h"
#include "circt/Dialect/CHALK/CHALKAttributes.h"
...
#include "circt/Dialect/CHALK/CHALKOpInterfaces.h.inc"
