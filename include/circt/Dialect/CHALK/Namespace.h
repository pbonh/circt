//===- Namespace.h - A symbol table for CHALK ops --------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the CHALK CircuitNamespace, a symbol table for
// `chalk.circuit` operations that allows for name collision resolution.
//
//===----------------------------------------------------------------------===//

#ifndef CIRCT_DIALECT_CHALK_NAMESPACE_H
#define CIRCT_DIALECT_CHALK_NAMESPACE_H
...
#endif // CIRCT_DIALECT_CHALK_NAMESPACE_H
