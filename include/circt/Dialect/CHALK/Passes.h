//===- Passes.h - CHALK pass entry points ----------------------*- C++ -*-===//
//
...
#ifndef CIRCT_DIALECT_CHALK_PASSES_H
#define CIRCT_DIALECT_CHALK_PASSES_H
...
createLowerCHALKAnnotationsPass(bool ignoreUnhandledAnnotations = false,
                                 bool ignoreClasslessAnnotations = false);

std::unique_ptr<mlir::Pass>
createLowerCHALKTypesPass(bool replSeqMem = false,
...
#endif // CIRCT_DIALECT_CHALK_PASSES_H
