...
// CHECK:  chalk.rectangle "CombRect2" {height = 2 : ui32, width = 2 : ui32, xCoord = 0 : i64, yCoord = 0 : i64}
// CHECK:  chalk.rectangle "CombRect3" {height = 2 : ui32, width = 3 : ui32, xCoord = 0 : i64, yCoord = 0 : i64}
// CHECK:  }
// CHECK: }
chalk.cell "CombCell" {} {
